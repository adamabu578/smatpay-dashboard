      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          {/* <div className="w-full max-w-[700px] text-center"> */}
            <label className="block font-medium text-2xl text-gray-700 mb-1" style={{ marginTop: "30px" }}>Electricity</label>
         

    

        <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1" style={{ marginTop: "30px" }}>Provider</label>
            <select
            ...
            >
              ...
              <option value="mtn">Ikeja Electricity - IKEDC</option>
              <option value="airtel">Eko Electricity - Eko Electricity </option>
          ...
          <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1">Meter Type</label>
            <select
              className="w-full h-12 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
              value={network}
              onChange={(e) => setNetwork(e.target.value)}
           ...
           <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1">Meter Number</label>
            <input
              type="text"
