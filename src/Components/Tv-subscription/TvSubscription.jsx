        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="w-full max-w-[700px] text-center">
            ...
            >
              ...
              <option value="airtel">GOTV</option>
              <option value="glo">Startimes</option>
              <option value="9mobile">Showmax</option>
            </select>
          </div>

          {/* Phone Number */}
          <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1">Smart Card Number</label>
            <input
              type="text"
          ...
          {/* <div className="w-full max-w-[700px] text-center">
            ...
            <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1">Bouquet Option</label>
            <select
              className="w-full h-12 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
              value={network}
              onChange={(e) => setNetwork(e.target.value)}
            >
              <option value="">Select</option>
              <option value="mtn">Renew</option>
              <option value="airtel">Change</option>
              {/* <option value="glo">Startimes</option>
              <option value="9mobile">Showmax</option> */}
            </select>
          </div>
