  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-6 md:p-8">
      <div className="w-full max-w-3xl rounded-lg shadow-lg ">
        ...
        <h1 className="text-2xl font-bold text-gray-800">E-PIN</h1>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="w-full max-w-[700px] text-center">
            <label className="block font-medium text-gray-700 mb-1 text-2xl" style={{ marginTop: "30px" }}>Service</label>
            <select
            ...
            >
              ...
              <option value="mtn">Rechard Card PIN </option>
              <option value="airtel">WAEC GCE Registration PIN </option>
              <option value="glo">WAEC Result Checker PIN</option>
              <option value="9mobile">UTME PIN (With Mock) </option>
              <option value="9mobile">UTME PIN (Without Mock) </option>
              <option value="9mobile">UTME PIN (Mock only) </option>
              <option value="9mobile">UTME PIN (direct entry) </option>
            </select>
          </div>
